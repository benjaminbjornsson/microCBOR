...
namespace dataItemMapRemoveKeyValueAtKeyTest {
...
TEST(dataItemMapRemoveKeyValueAtKeyTest, dataItemMapRemoveKeyValueAtKeyFourToZero) {
	DataItem *mapItem = decode(mapCbor);
	DataItem *keyItem;
	uint8_t *final;
	
	keyItem = decode(key4Cbor);
	dataItemMapRemoveKeyValueAtKey(mapItem, keyItem);
...
TEST(dataItemMapRemoveKeyValueAtKeyTest, dataItemMapRemoveKeyValueAtKeyZero) {
	DataItem *mapItem = decode(mapCbor);
	DataItem *keyItem;
	uint8_t *final;
...
TEST(dataItemMapRemoveKeyValueAtKeyTest, dataItemMapRemoveKeyValueAtKeyRandom) {
	DataItem *mapItem = decode(mapCbor);
	DataItem *keyItem;
	uint8_t *final;
